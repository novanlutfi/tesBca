...
export default {
  ...
  methods: {
    ...
    submit () {
      if (this.$store.state.hobbySelected === true) {
        this.$store.commit('postHobby')
      } else if (this.$store.state.growthSelected === true) {
        this.$store.commit('postGrowth')
      } else if (this.$store.state.enterpriseSelected === true) {
        this.$store.commit('postEnterprise')
      } else if (this.$store.state.bussinessSelected === true) {
        this.$store.commit('postBussiness')
      } else {
...
.modal-backdrop {
    ...
    left: 0;
    right: 0;
    background-color: rgba(22, 25, 236, 0.3);
    display: flex;
